...
function main(): void {
  ...
  const pairs: Pair[] = [
    ...
    { name: '"New" coach badge', fg: t(tokens, 'tb-orange-deep'), bg: t(tokens, 'tb-orange-subtle'), min: 4.5 },
    { name: 'Body text on accent tint', fg: t(tokens, 'tb-ink'), bg: t(tokens, 'tb-orange-subtle'), min: 4.5 },
    { name: 'Body text on OK tint (chips)', fg: t(tokens, 'tb-ink'), bg: t(tokens, 'tb-ok-bg'), min: 4.5 },
    { name: 'Body text on warn tint', fg: t(tokens, 'tb-ink'), bg: t(tokens, 'tb-warn-bg'), min: 4.5 },
    { name: 'Warn icon on surface (UI)', fg: t(tokens, 'tb-warn'), bg: t(tokens, 'tb-surface'), min: 3, large: true },

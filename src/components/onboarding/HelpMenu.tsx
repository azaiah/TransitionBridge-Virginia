...
/**
 * The "?" in the top bar. Replays the three coach marks and lists the two shortcuts,
 * because a dismissed-forever tour still has to be findable again.
 */
